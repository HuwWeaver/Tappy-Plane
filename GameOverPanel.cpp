...
GameOverPanel::GameOverPanel(const Vector2& windowSize) : windowDimensions(&windowSize)
{
...
void GameOverPanel::SetValues(const float& time, const int& obstacles, const int& collectibles)
{
    timeScore = &time;
